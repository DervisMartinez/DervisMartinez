<h1 align="center">Hi 👋, I'm Dervis Martinez</h1>
<h3 align="center">Computer Science Student at University of Carabobo | Web Developer</h3>
...
- 🔭 Actualmente estudiando **Computación** en la **Universidad de Carabobo**.
- 🌱 Aprendiendo y mejorando en **Algoritmos, Estructuras de Datos, C++, Bases de Datos y Desarrollo Web**.
...
- 🎓 **Proyectos Universitarios**: Desarrollo continuo de repositorios de Algoritmos, Programación 1 y 2, Bases de Datos y Arquitectura en la Universidad de Carabobo (C / C++ / TeX).
- 🔌 **Desarrollo Web**: Creador del plugin `bcv-banner-shorcode` para WordPress y formularios de contacto dinámicos (PHP, JavaScript).
